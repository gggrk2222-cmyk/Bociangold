    ...
    <main className="site-shell">
      ...
      <section className="hero" id="start">
        <div className="hero-copy">
          <div className="eyebrow"><span className="eyebrow-dot" /> Siano z kujawskich i krajeńskich łąk</div>
        ...
        <div className="hero-art" aria-label="Kujawska i krajeńska łąka z tradycyjną szopą w murze pruskim"><div className="art-glow" /><div className="art-sticker"><Sparkles size={15} /> Ręcznie pakowane</div><div className="hero-scene-frame"><img className="hero-scene-image" src="hero-mur-pruski.png" alt="Kujawska i krajeńska łąka z tradycyjną szopą w murze pruskim i królikiem" fetchPriority="high" /><span className="scene-note">Kujawy · Krajna</span></div><div className="art-caption"><span>01</span><span>naturalny skład</span><span>kujawska i krajeńska łąka</span></div></div>
      </section>
