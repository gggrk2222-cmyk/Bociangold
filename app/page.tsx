  ...
  return (
    <main className="site-shell">
      <nav className="topbar" aria-label="Główna nawigacja">
        <a href="#start" className="brand-lockup" aria-label="Bocian Gold – Złota Łąka"><img src="logo-bocian-gold-transparent.png" alt="Bocian Gold – Złota Łąka" /></a>
      ...
      <section className="benefits" aria-label="Najważniejsze cechy">
        ...
        <div><span className="benefit-icon"><Wheat size={20} /></span><div><strong>Suszone na słońcu</strong><small>Naturalny kolor i piękny zapach siana</small></div></div>
      ...
      <footer className="footer"><div className="footer-brand"><img src="logo-bocian-gold-transparent.png" alt="Bocian Gold" /><span>Naturalne siano łąkowe premium</span></div><div className="footer-meta"><span>© 2026 Bocian Gold</span><a href="#start">Wróć na górę ↑</a></div></footer>
    </main>
  );
}
